...
(1) **The importance of global filter $W$ for ID embedding**. As explained in part 1, the denoised item representation can be interpreted as the item-position convolutional representations for capturing sequential patterns of sequence representation learning, which is crucial in sequential recommendation especially for dense datasets relying on ID modeling like ML-1M. 
